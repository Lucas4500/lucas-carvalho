<div class="card mx-auto col-md-6">
    <div class="card-body">
        <form action="<?= $action ?>" method="post">
            <p class="h4 text-center py-4">Editar Registro de Custo</p>
            <?= $info ?>
            ...
            <select id="custo" class="form-control" name="custo" disabled>
            </select>
            <br>
            <label for="valor" class="grey-text font-weight-light">Valor Gasto</label>
            <input value="<?= $data->valor ? $data->valor : '' ?>" type="number" id="valor" name="valor" class="form-control" min="0.00" step="0.01" required>
            <br>
